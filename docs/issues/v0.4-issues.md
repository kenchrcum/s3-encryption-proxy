...
### Implementation Guide
- [x] Generate schema from structs or maintain YAML with comments.
- [x] Map env vars; provide examples.

### Definition of Done
- [x] Clear schema table with examples
...
### Definition of Done
- [x] Baseline metrics recorded; regressions tracked
...
### Definition of Done
- [x] Diagrams in `docs/`; ADRs committed and linked
